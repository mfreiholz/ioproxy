...
#include "ioproxy/util/HumanReadableFormatter.hpp"
#include <QDateTime>
#include <chrono>
...
ConsoleStatusPrinter::ConsoleStatusPrinter(ioproxy::Engine* engine, QObject* parent)
	: QObject(parent)
	, m_engine(engine)
	, m_statisticTimer()
{
	QObject::connect(&m_statisticTimer, &QTimer::timeout, this, &ConsoleStatusPrinter::printStatistics);
}
...
void ConsoleStatusPrinter::printStatistics()
{
